...
import { agricultureHeroData } from "@/data/agricultureData";
      ...
      <div className="mx-auto max-w-7xl text-left sm:text-center">
        ...
        {subtitle && (
          <motion.p
            ...
            className="mb-3 text-left sm:text-center text-sm font-normal tracking-tight text-gray-600 sm:text-xl md:text-4xl"
          >
            {subtitle}
          </motion.p>
        )}
        ...
        <motion.h1
          ...
          className="text-left sm:text-center text-4xl font-normal leading-tight tracking-tight text-[#658e3e] sm:text-5xl lg:text-6xl"
        >
          {title}
        </motion.h1>
        ...
        {description && (
          <motion.p
            ...
            className="mx-auto text-left sm:text-center mt-4 max-w-3xl text-base leading-relaxed text-gray-600 sm:text-lg"
          >
            {description}
          </motion.p>
        )}
